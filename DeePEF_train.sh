...
#SBATCH --output DeePEF_themodynamic.out                     ### output log for running job - %J for job number
...
python train-thermodynamics.py ### execute python script – replace with your own command