...
#SBATCH --job-name DeePEF_train_no_const                       ### name of the job
#SBATCH --output DeePEF_train_no_const.out                     ### output log for running job - %J for job number
...
python train-hydro.py ./trianed_models_no_const/ ### execute python script – replace with your own command