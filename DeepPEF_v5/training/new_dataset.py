...
RANDOM_SEED = 42
NANO_TO_ANGSTROM = 0.1
# Data paths resolved through config_paths (env DEEPPEF_DATA_ROOT / --data_root / ./data).
TM_PATH = config_paths.thermompnn_test_csv()
TM_TRAIN_PATH = config_paths.thermompnn_train_csv()
TENSOR_STORE = config_paths.tensor_root()
MUTATIONS_STORE = config_paths.mut_root()
