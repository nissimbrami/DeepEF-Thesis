...
_p.add_argument('--desc_unfolded_zero', action='store_true', help="B2b: zero the W6 descriptor block in the UNFOLDED pass, making it state-dependent. Without this the block is bit-identical in both states and cancels exactly in dG, which is the proved cause of the W6 collapse (frozen RMSE 2.529). Default off = byte-identical.")
...
CFG.desc_unfolded_zero = _a.desc_unfolded_zero
