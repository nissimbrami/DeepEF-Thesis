...
def numerical_LG(Ejf, Eh1, Eh2, h = CFG.h):
    ...
    # Eh1 = E0+ deltaE1
    # Eh2 = E0+ deltaE2
    # (E0+ deltaE1 - E0- deltaE2)**2 = (deltaE1 - deltaE2)**2 
    # deltaE1**2 - 2deltaE1*deltaE2 + deltaE2**2 -E0+ deltaE1 - 2E0 + E0- deltaE2 + E0 = deltaE1**2 - 2deltaE1*deltaE2 + deltaE2**2
...
def main():
    ...
    d_params = data_params(num_workers =CFG.num_workers, batch_size=CFG.batch_size,cuda=CFG.cuda,constraint=CFG.constraint, debug=CFG.debug,dataset='scn',LLM_EMB = False)
